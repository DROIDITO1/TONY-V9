...
if wget -q https://github.com/DROIDITO1/TONY-V9/raw/master/audio/"$random_mp3"; then
...
echo -e "\033[1;35m"
git clone https://github.com/DROIDITO1/TONY-V9.git
